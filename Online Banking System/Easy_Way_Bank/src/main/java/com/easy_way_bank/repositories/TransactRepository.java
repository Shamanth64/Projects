...
import com.easy_way_bank.models.Transact;
...
public interface TransactRepository extends CrudRepository<Transact, Integer> {
    @Modifying
    @Query(value = "insert into bank.transaction_history(account_id, transaction_type, amount, source, status, reason_code, created_at)" +
